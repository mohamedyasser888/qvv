-- Some Supabase projects do not have pgcrypto's gen_random_bytes(integer)
-- installed. Replace the original kickoff function with an extension-free
-- server-side coin toss. Apply this after migration 017 when migration 016
-- was previously attempted or already recorded by the migration runner.
